...
for area in ['NCA', 'SCAN', 'WOSCAN']:
    ...
    #ax[2].plot(op_tot[0,:],op_cap[1,:]/op_can[1,:], label='perc canc for capacity in {}'.format(area))
    ax[3].set_title('Diagnostic waiting times over 4 weeks')
    ax[3].plot(di4[0,:],di4[1,:], label='imaging 4 weeks in {}'.format(area))
    ax[3].plot(de4[0,:],de4[1,:], label='endoscopy 4 weeks in {}'.format(area))
    ax[4].set_title('Diagnostic waiting times over 6 weeks')
    ax[4].plot(di6[0,:],di6[1,:], label='imaging 6 weeks in {}'.format(area))
    ax[4].plot(de6[0,:],de6[1,:], label='endoscopy 6 weeks in {}'.format(area))
    ax[5].set_title('Quarterly covid data')
    #ax[5].plot(cov_pos[0,:],cov_pos[1,:], label='positive covid in {}'.format(area))
...
plt.savefig('some_datasets_plotted.png')
plt.show()